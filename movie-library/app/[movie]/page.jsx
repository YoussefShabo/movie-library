    ...
    return(
        <div>
            <div>
                ...
                <h2 className="text-sm bg-green-800 inline-block py-1 px-2 rounded">{res.status}</h2>
                <Image className="my-6 w-full" src={imagePath + res.backdrop_path} width={1000} height={900} priority/>
                <p>{res.overview}</p>
            </div>
        </div>
    )
